var LOOKUP_TABLE = [0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50A5,
  ...
  0x4AD4, 0x7AB7,
  0x6A96, 0x1A71, 0x0A50, 0x3A33, 0x2A12, 0xDBFD, 0xCBDC, 0xFBBF, 0xEB9E,
  0x9B79, 0x8B58,
  ...
  0x5ED5, 0x4EF4,
  0x3E13, 0x2E32, 0x1E51, 0x0E70, 0xFF9F, 0xEFBE, 0xDFDD, 0xCFFC, 0xBF1B,
  0xAF3A, 0x9F59,
  ...
  0x6277, 0x7256,
  0xB5EA, 0xA5CB, 0x95A8, 0x8589, 0xF56E, 0xE54F, 0xD52C, 0xC50D, 0x34E2,
  0x24C3, 0x14A0,
  0x0481, 0x7466, 0x6447, 0x5424, 0x4405, 0xA7DB, 0xB7FA, 0x8799, 0x97B8,
  0xE75F, 0xF77E,
  0xC71D, 0xD73C, 0x26D3, 0x36F2, 0x0691, 0x16B0, 0x6657, 0x7676, 0x4615,
  0x5634, 0xD94C,
  ...
  0x9BD8, 0xABBB,
  0xBB9A, 0x4A75, 0x5A54, 0x6A37, 0x7A16, 0x0AF1, 0x1AD0, 0x2AB3, 0x3A92,
  0xFD2E, 0xED0F,
...
function getCRC16(bytes) {
  return getCRC16F3(bytes, 0, bytes.length);
}

function getSlot(key) {
  key = extractHashTag(key, true);
  return getCRC16(Buffer.from(key)) & (16384 - 1);
}

function extractHashTag(key, returnKeyOnAbsence) {
  var s = key.indexOf("{");
  if (s > -1) {
